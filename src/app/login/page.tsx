        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4">
              <a href="https://chat.whatsapp.com/CQMqkEcB0LwFLlG0uIyEOX?mode=gi_t" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-emerald-400 transition-colors" title="Grupo de WhatsApp">
